    ...
    <section id="about" className="section-pad">
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div className="about-grid">
          <FadeIn delay={100}>
            <div>
              <p style={{ color: COLORS.textDim, lineHeight: 1.9, fontSize: 15, marginBottom: 20 }}>
              ...
              <p style={{ color: COLORS.textDim, lineHeight: 1.9, fontSize: 15 }}>
                I hold a Bachelor's in Computer Science from the{" "}
                <span style={{ color: COLORS.accent }}>University of Karachi</span>{" "}
          ...
          <FadeIn delay={200}>
            <TiltCard style={{ ...cardStyle, fontFamily: "monospace", fontSize: 13 }}>
              ...
              {[
                ...
                <div key={k} style={{ display: "flex", gap: 8, marginBottom: 8, flexWrap: "wrap" }}>
                  <span style={{ color: COLORS.accentAlt, whiteSpace: "nowrap" }}>{k}:</span>
